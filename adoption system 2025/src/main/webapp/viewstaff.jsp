...
<div class="profile-text"> 
 ...
 <label for="name" >Staff ID: <c:out value="${sessionScope.StaffID}"/></label><br><br> 
 <label for="name">Name: <c:out value="${sessionScope.StaffName}"/></label><br><br> 
 <label for="phone">Phone Number:  <c:out value="${sessionScope.StaffPhoneNum}"/></label><br><br>
 <label for="email">Email: <c:out value="${sessionScope.StaffEmail}"/></label><br><br> 
 <label for="password">Password: <c:out value="${sessionScope.StaffPass}"/></label><br><br> 
 <div>
 <div class="button-wrapper"> 
 <a class="button-container" href="updateStaffController?StaffID=<c:out value="${sessionScope.StaffID}"/>"><i class="fas fa-edit"></i></a> 
 <a class="button-danger" id="<c:out value="${sessionScope.StaffID}"/>" onclick="confirmation(this.id)"><i class="fas fa-trash-alt"></i></a>
 </div>
 </div>
 </div>
</form> 
...
<script>
    ...
    function updateStaffController(StaffID) {
        // Construct the URL
        var url = 'updateStaffController?StaffID=' + StaffID;
