...
<head>
    ...
    <title>Pet Current Condition (Customer)</title>
        ...
        <tbody id="tableBody">
            <input type="hidden" class="form-control" id="request" name="RequestID" value="<c:out value="${r.requestID}"/>">
                ...
                <td><c:out value="${loopStatus.index + 1}"/></td>
                    ...
                    <td>
                        <a class="btn btn-primary" onclick="addPostAdoptionController2('<c:out value="${r.petID}"/>')">
...
<script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
    ...
    <script>
     ...
     function addPostAdoptionController2(petID) {
         var url = 'addPostAdoptionController2?PetID=' + petID;
         window.location.href = url;
     }

     function viewPost(custID) {
         var url = 'listPostCustController2?CustID=' + custID;
         window.location.href = url;
     }
     </script>
	 <style>
