...
<section id="questionTable">
	...
	<thead>
		<tr>
			<th>QuestionID</th>
			<th>QuestionExample</th>
			<th>Action</th>
		</tr>
		</thead>
		<tbody id="tableBody">
		<c:forEach items="${questions}" var="q" varStatus="questions">
		<tr>
			<td><c:out value="${q.questionID}"/></td>
			<td><c:out value="${q.questionExample}"/></td>
			<td><a class="btn btn-primary" href="viewQuestionController?QuestionID=<c:out value="${q.questionID}"/>"><i class="fas fa-eye"></i></a>
			<a class="btn btn-primary" href="updateQuestionController?QuestionID=<c:out value="${q.questionID}"/>"><i class="fas fa-edit"></i></a>
			<button class="btn btn-danger" id="<c:out value="${q.questionID}"/>" onclick="confirmation(this.id)"><i class="fas fa-trash-alt"></i></button></td>
...
function confirmation(questionID) {
	...
	if (r == true) {
		location.href = 'deleteQuestionController?QuestionID=' + questionID;
