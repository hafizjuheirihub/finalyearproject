...
<body>
    ...
    <div class="signup-container">
        <div class="form_area">
            ...
            <form action="signupCustController" method="post" autocomplete="off"  class="sign-in-form" onsubmit="myFunction()">
                <div class="form_group">
                    <label for="email">Email</label>
                    <input type="email" id="email" name="CustEmail" class="form_style" placeholder="Enter your email" required>
                </div>
                <div class="form_group">
                    <label for="phone">Phone Number</label>
                    <input type="tel" id="phone" name="CustPhoneNum" class="form_style" placeholder="Enter your phone number" pattern="[0-9]{10}" title="Please enter a 10-digit phone number" required>
                </div>
                <div class="form_group">
                    <label for="username">Username</label>
                    <input  type="text" id="username" name="CustName" class="form_style" placeholder="Enter your username" required>
                </div>
                <div class="form_group">
                    <label for="password">Password</label>
                    <input type="password" id="password" name="CustPass" class="form_style" placeholder="Enter your password" minlength="8" pattern=".{8,}" title="Password must be at least 8 characters long" required>
                </div>
                <div>
				<button class="btn">SIGN UP</button><br>
<!--                     Have an Account? <a class="link" href="logincust.jsp">Sign up Here!</a><br>
