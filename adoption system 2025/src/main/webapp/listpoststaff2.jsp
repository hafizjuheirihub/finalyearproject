        ...
        <div id="ApproveList" class="tab-content">
            <div class="table-responsive">
                ...
                <table id="example" class="table table-striped">
                    ...
                    <tbody id="tableBody">
                        <c:forEach items="${postadopts}" var="pa" varStatus="loopStatus">
                            <tr>
                            <td><c:out value="${loopStatus.index + 1}"/></td>
                                ...
                                <td><button class="button-danger" id="<c:out value="${pa.postID}"/>" onclick="confirmation(this.id)"><i class="fas fa-trash-alt"></i></button></td>
                            </tr>
                        </c:forEach>
                    </tbody>
                </table>
...
<script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
	...
	<script>
	 ...
	 function confirmation(postID) {
	    	...
	    	if (r == true) {
	    		location.href = 'deletePostAdoptionController2?PostID=' + postID;
