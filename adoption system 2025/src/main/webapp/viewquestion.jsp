...
<div class="profile-text"> 
 ...
 <br>
 <input type="hidden" class="form-control" id="question" name="QuestionID" value="<c:out value="${q.questionID}"/>">
 <label for="name" >ID: <c:out value="${q.questionID}"/></label><br><br> 
 <label for="name">Question: <c:out value="${q.questionExample}"/></label><br> 
