...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item"> 
                        <a class="nav-link" href="postadoptform.jsp"> Post Adoption</a>
                    </li>
                </ul>
	...
	<div class="form">
        <h2>Update Post Adoption Form</h2>
        <form action="updatePostAdoptionController" autocomplete="off" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select id="pet" name="PostActivity" class="form-control">
                    ...
                    <option value="Second Vaccination">Second Vaccination</option>
