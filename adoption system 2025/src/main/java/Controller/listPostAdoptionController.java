...
public class listPostAdoptionController extends HttpServlet {
	private static final long serialVersionUID = 1L;
    private RequestDAO dao;  
    /**
     * @see HttpServlet#HttpServlet()
     */
    public listPostAdoptionController() {
        super();
        dao = new RequestDAO();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (session != null && session.getAttribute("CustID") != null) {
            ...
            RequestDispatcher view = request.getRequestDispatcher("postadopt.jsp");
