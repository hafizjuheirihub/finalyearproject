...
public class addPostAdoptionController2 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        RequestDispatcher view = request.getRequestDispatcher("postadoptform2.jsp");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            System.err.println("Invalid RequestID: " + request.getParameter("RequestID"));
        }
        try {
        ...
        dao.addPostAdoption(postadopts, imageData);
		  ...
		  request.setAttribute("pa", PostAdoptionDAO.getAllPostAdopts());
		    response.sendRedirect("listPostCustController2");
