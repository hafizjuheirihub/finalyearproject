...
public class addPostAdoptionController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        RequestDispatcher view = request.getRequestDispatcher("postadoptform.jsp");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        dao.addPostAdoption(postadopts, imageData);
		  ...
		  request.setAttribute("pa", PostAdoptionDAO.getAllPostAdopts());
		    response.sendRedirect("listPostCustController");
