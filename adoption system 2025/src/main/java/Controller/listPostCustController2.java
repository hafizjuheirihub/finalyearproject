...
public class listPostCustController2 extends HttpServlet {
    private static final long serialVersionUID = 1L;
    private PostAdoptionDAO dao;

    public listPostCustController2() {
        super();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (session != null && session.getAttribute("CustID") != null) {
            ...
            List<PostAdoptionBean> postadopts = dao.getAllSubmittedPostAdoptsByCustID2(custID);
